...
public class TeaExpert {
    public List<String> getBrands(String color){
        ...
        if(color.equals("amber")){
            brands.add(getTeaBrandByName("Haftom Tea").getName());
    ...
    public List<TeaBrand> getTeaBrands(){
        if(teaBrands == null)//lazy loading
        {
            ...
            teaBrands.add(new TeaBrand("Haftom's Tea", "Haftom's Tea of Ethiopia is a company which produces tea.", "http://www.herbsforlivinglife.com/wp-content/uploads/2014/12/tea-for-life-2.jpg"));
